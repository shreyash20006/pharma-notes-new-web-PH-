    ...
    <div className="live-it-up-page">
      ...
      <div className="search-wrap">
        <div className="search-bar">
          ...
          <input type="text" placeholder="Search for 'Pizza'" readOnly />
          <svg className="mic-icon" width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
            <path d="M12 1a3 3 0 0 0-3 3v8a3 3 0 0 0 6 0V4a3 3 0 0 0-3-3z" />
            <path d="M19 10v2a7 7 0 0 1-14 0v-2" fill="none" stroke="#1a6ff4" strokeWidth="2" strokeLinecap="round" />
            <line x1="12" y1="19" x2="12" y2="23" stroke="#1a6ff4" strokeWidth="2" strokeLinecap="round" />
            <line x1="8" y1="23" x2="16" y2="23" stroke="#1a6ff4" strokeWidth="2" strokeLinecap="round" />
          </svg>
        </div>
      </div>
      ...
      <div className="msg-wrap">
        <h2>
          Sorry! Restaurants aren't accepting
          <br />
          orders at the moment.
        </h2>
        <span className="cursive">please check back later</span>
      </div>
